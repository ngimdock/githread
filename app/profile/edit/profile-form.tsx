...
const EditProfileFormScheme = z.object({
...
export type EditProfileFormType = z.infer<typeof EditProfileFormScheme>;

type ProfileFormProps = {
  onSubmit: (values: EditProfileFormType) => Promise<string | void>;
  user: UserEditType;
};

export const ProfileForm = ({ onSubmit, user }: ProfileFormProps) => {
  const form = useZodForm({
    schema: EditProfileFormScheme,
    defaultValues: {
      name: user.name ?? "",
